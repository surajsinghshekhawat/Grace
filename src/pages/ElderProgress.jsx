...
/** English plural suffix only; Hindi/Tamil strings omit {s}. */
...
export default function ElderProgress() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      apiFetch("/api/elder/assessments?limit=36").catch(() => []),
      apiFetch("/api/check-ins/daily?days=30").catch(() => []),
      ...
      <div className="px-6 -mt-4 max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <WellnessCard>
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h2 className="text-gray-800 mb-1" style={{ fontSize: "20px", fontWeight: 600 }}>
                    {t("prog.depressionRiskTitle")}
                  </h2>
                  {riskLabelText ? (
                    <span
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            <WellnessCard>
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h2 className="text-gray-800 mb-1" style={{ fontSize: "20px", fontWeight: 600 }}>
                    {t("prog.qolScoreTitle")}
                  </h2>
                  {displayQol10 != null ? (
                    <span className="text-gray-800" style={{ fontSize: "32px", fontWeight: 700 }}>
                      {displayQol10}
          ...
          {hasOlderAssessmentsOutsideWindow && (
            <div className="md:col-span-2 text-sm text-gray-600 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3">
              {t("prog.windowCharts", {
          ...
          {trendData.length >= 2 && (
            ...
            >
              <WellnessCard>
                <h2 className="text-gray-800 mb-4" style={{ fontSize: "20px", fontWeight: 600 }}>
                  {t("prog.qolFromAssessments")}
                </h2>
                <p className="text-gray-600 mb-4 text-sm">
          ...
          {moodTrendChartData.length >= 2 && (
            ...
            >
              <WellnessCard>
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Last {CHECKIN_MOOD_WINDOW_DAYS} days · {moodTrendChartData.length} rating
                  {moodTrendChartData.length === 1 ? "" : "s"} on a 1–5 scale (higher = better mood).
                </p>
                        ...
                        return (
                          <tr key={a.id} className="border-t border-slate-100 hover:bg-slate-50/80">
                            <td className="p-3 text-gray-800 whitespace-nowrap">
                              {formatShortDate(a.created_at, lang)}
                            </td>
          ...
          {radarData.length > 0 && (
            ...
            >
              <WellnessCard>
                ...
                <p className="text-gray-600 mb-4 text-sm">{t("prog.radarSub")}</p>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mt-6 mb-6">
